...
function ObjectSelector({ isVideoUploaded, onObjectsSelected }) {
  ...
  return (
    <div className="flex items-start">
      <div className="select-section flex flex-col w-40">
      ...
      {selectedObjects.length > 0 && (
        <div className="selected-objects flex flex-col w-72 border-l-2 border-gray-300 pl-5 max-h-24 overflow-y-auto">
